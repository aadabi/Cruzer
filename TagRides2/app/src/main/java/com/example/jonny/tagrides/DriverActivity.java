...
public class DriverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rideList = findViewById(R.id.allRidesview);
        ...
        liveData.observe(this, new Observer<DataSnapshot> ()  {
            ...
            public void onChanged(@Nullable DataSnapshot dataSnapshot) {
                if (dataSnapshot != null) {
                    ArrayList<String> myRides = new ArrayList<>();
                    ...
                    for (DataSnapshot i : dataSnapshot.getChildren()) {
                        ...
                        Ride rideInfo = i.getValue(Ride.class);
                        myRides.add(rideInfo.getDestination());
                        System.out.println("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
                    }
                    rideList.setAdapter(adapter);
                    adapter.notifyDataSetChanged();
                    System.out.println("&&&&&&&&&&&destination: "+ myRides);
