...
class PaymentViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let itemImage = UIImageView(image: UIImage(named: "tagrides_logo"))
        ...
        self.payButton.backgroundColor = UIColor.green
    ...
    func selectPaymentMethodAction() {
        guard let paymentMethodNonce = self.paymentMethod?.nonce else {
            showDropIn(clientTokenOrTokenizationKey: "sandbox_btq2sfbm_4h4ptsnrxgcp6pc6")
            return
        }
